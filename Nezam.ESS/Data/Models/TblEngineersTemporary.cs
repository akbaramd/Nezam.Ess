...
public class TblEngineersTemporary
{
    ...
    public byte[]? ImgNid { get; set; }

    public byte[]? ImgBc { get; set; }

    public byte[]? ImgCert { get; set; }

    public byte[]? ImgSokoonat { get; set; }

    public byte[]? ImgEntegal { get; set; }

    public byte[]? ImgPayan { get; set; }
