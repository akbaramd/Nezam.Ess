...
public class UserProfileUpdatedExternalEventHandler2 : INotificationHandler<UserProfileUpdatedEvent>
{
    public IMemberRepository MemberRepository { get; }

    private readonly IUnitOfWorkManager _unitOfWorkManager;
    private readonly ILogger<UserProfileUpdatedExternalEventHandler2> _logger;

    public UserProfileUpdatedExternalEventHandler2(
   
        IUnitOfWorkManager unitOfWorkManager,
        IMemberRepository memberRepository,
        ILogger<UserProfileUpdatedExternalEventHandler2> logger)
    {
