...
namespace Nezam.EES.Slice.Identity.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "UserVerificationTokenType",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserVerificationTokenType", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserVerificationTokens", x => x.TokenId);
                    table.ForeignKey(
                        name: "FK_UserVerificationTokens_UserVerificationTokenType_TypeId",
                        column: x => x.TypeId,
                        principalTable: "UserVerificationTokenType",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserVerificationTokens_TypeId",
